  ...
  return (
    <>
      <div className="flex flex-col items-center p-4">
        <div className="bg-gray-900 text-white shadow-lg w-full sm:w-80 sm:m-4 transform transition-all hover:scale-105 hover:shadow-2xl">
          <img src={photo} alt="Article" className="w-full h-48 object-cover" />
          <div className="p-4">
